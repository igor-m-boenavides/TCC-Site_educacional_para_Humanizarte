...
<nav class="navbar navbar-expand-lg navbar-light bg-light" id="navbar">
  ...
  <a class="navbar-brand" href="suntzu.php" id="logo_texto"><img alt="Logo Humanizarte" src="../imagens/logo.png" width="40" height="40">Humanizarte</a>
...
if (isset($_SESSION['nome']) && !empty($_SESSION['nome']) && isset($_SESSION['senha']) && !empty($_SESSION['senha'])) {
  ...
  try {
    ...
    // Consultar as aulas da turma "Sun Tzu" (id_turma = 3)
    $stmt = $pdo->prepare('SELECT a.id_aula, a.nome, a.url_video, a.nome_video, a.url_anexo, a.nome_anexo FROM aula a INNER JOIN aula_turma at ON a.id_aula = at.id_aula WHERE at.id_turma = 3');
    $stmt->execute();
