...
<div class="botao-cadastro">
  <p><a href="cadastroLogos.html"><i class="bi bi-plus-circle-fill" id="add-aula"></i> Cadastrar aula</a></p>
</div>
...
<div class="aula">
  ...
  try {
    ...
    $stmt = $pdo->prepare('SELECT a.id_aula, a.nome, a.url_video, a.nome_video, a.url_anexo, a.nome_anexo FROM aula a INNER JOIN aula_turma at ON a.id_aula = at.id_aula WHERE at.id_turma = 1');
    $stmt->execute();
